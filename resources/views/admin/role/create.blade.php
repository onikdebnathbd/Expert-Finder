                ...
                <div class="card card-default" data-select2-id="16">
                    ...
                    <form role="form" action="{{ route('role.store') }}" method="post">
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : ''  }}" name="name" id="name" placeholder="Enter user role name">
                            ...
                            <!-- /.row -->
                            <button type="submit" class="btn btn-primary" style="margin-top: 5px; margin-bottom: 5px;">Add Role</button>
                        </div>
                        <!-- /.card-body -->
                    </form>
                </div>
