                                ...
                                @foreach($roles as $role)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm" href="{{ route('role.edit', $role->id) }}"><i class="far fa-edit"></i></a>
                                            @endcan
                                            <!-- End Edit -->

                                            <!-- Delete -->
                                            @can('roles.delete', Auth::user())
                                                <form style="display: inline-block;" id="delete-form-{{ $role->id }}" action="{{ route('role.destroy', $role->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm delete-role" id="{{ $role->id }}"><i class="far fa-trash-alt"></i></button>
                                                </form>
                                            @endcan
                                            <!-- End Delete -->
                                        </td>
