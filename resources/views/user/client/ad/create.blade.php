        ...
        <section class="content profile-content">
            <div class="container">
                <div class="card" style="border-top-left-radius: 0; border-top-right-radius: 0;">
                    ...
                    <div class="card-body">
                        <form role="form" action="{{ route('ad.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="title">Job Title</label>
                                        <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : ''  }}" name="title" id="title" placeholder="Enter ad title">
                                        @include('includes.errors.title')
                                    </div>
                                    <div class="form-group">
                                        <label for="slug">Job Slug</label>
                                        <input type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : ''  }}" name="slug" id="slug" placeholder="Enter ad slug">
                                        @include('includes.errors.slug')
                                    </div>
                                    <div class="form-group">
                                        <label for="category">Offer to A Specific Expert</label>
                                        <select class="select2bs4 select2-hidden-accessible{{--{{ $errors->has('name') ? ' is-invalid' : ''  }}--}}" name="category[]" id="category" multiple="" data-placeholder="Select expert categories" style="width: 100%;" data-select2-id="35" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : ''  }}" style="height: 123px;" placeholder="Enter ad description"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label style="font-weight: normal; color: #495057;">
                                                <input type="checkbox" style="margin-right: 3px; display: inline-block;" name="visibility" value="1">Visible
                                            </label>
                                        </div>
                                    </div>
                                </div>
